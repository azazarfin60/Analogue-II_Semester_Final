...
```mermaid
pie title Mark Weight Distribution (Approximate)
    "Cascaded/Multistage Amplifiers" : 22
    "Op-Amp Applications (Sum/Diff/Int)" : 18
    "555 Timer Circuits" : 15
    "Oscillators (Wien/RC/LC)" : 14
    "Active Filters" : 10
    "Frequency Response (fL, fH)" : 8
    "Feedback Theory" : 5
    "CMOS Logic" : 4
    "Current Mirror / Darlington" : 4
```
